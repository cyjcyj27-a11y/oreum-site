...
| 2026-09-07 | Indie DB 게임 | https://www.indiedb.com/games/finger-kick | 핑거킥(리그전 판) | Homepage → 영어 소개 페이지. Engine HTML5, Platform Web, Sport. 그림 5장(타이틀·경기·순위표·세로 2장, 사이트판 캡처). 상점 주소·Files 는 비움(내려받기 없음). 소식글 1개(검수 대기) |

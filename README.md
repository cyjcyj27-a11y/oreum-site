...
| 2026-09-07 | Indie DB 회사 | https://www.indiedb.com/company/oreum-games | (회사) | Developer 페이지. Homepage → oreumgames.com/en/ (UTM 은 Indie DB 가 떼어 냄). 로고=사이트 아이콘, 머리 그림=핑거킥 배너 950×150 |
| 2026-09-07 | Indie DB 게임 | https://www.indiedb.com/games/finger-kick | 핑거킥(리그전 판) | Homepage → 영어 소개 페이지. Engine HTML5, Platform Web, Sport. 그림 5장(타이틀·경기·순위표·세로 2장, 사이트판 캡처). 상점 주소·Files 는 비움(내려받기 없음). 소식글 1개 — 2026-09-07 저녁 뉴스 기사 꼴로 재작성(그림 4장·itch 링크), Staff recheck 체크 + feillyne 쪽지로 재심사 요청 |
| 2026-09-21 | itch.io | https://oreumgames.itch.io/foosball | 테이블축구게임(FOOSBALL, 영어판 실행 포함) | 두 번째 itch 게임. 설명 첫 줄 "our second soccer game, after FINGER KICK". 알약 → oreumgames.com/en/?utm_source=itch. 2026-09-21 사장님이 Public 전환·공개 완료 |
| 2026-09-21 | itch.io 게시판 | https://itch.io/t/6976634/foosball-3d-table-soccer-with-real-rod-physics-2-players-on-one-keyboard-browser-free | 테이블축구게임 | Release Announcements 글. 태그 Browser, 그림은 Choose image 로 타이틀 스크린샷 재사용. 첫 줄 "our second soccer game after FINGER KICK" |
| 2026-09-21 | Indie DB 게임 | https://www.indiedb.com/games/foosball | 테이블축구게임(FOOSBALL) | Homepage → 영어 소개 페이지. Sport/Web/HTML5, 그림 5장+쇼츠 영상(720p mp4). 내려받기 없음. 설명은 개발자 말투(물리 고생담) |

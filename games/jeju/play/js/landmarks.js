...
(function () {
  ...
  const P = {
    ...
    fall(s) { const x = s.x, z = s.z;
      // 절벽과 소(沼)를 따로 놓는다. 한 덩어리로 놓으면 비탈에서 통째로 가장 높은 모서리에 올라가
      // 소가 땅보다 1m 넘게 떠서, 그 위를 걷는 사람이 허리까지 파묻혀 보였다 (사장님 2026-09-13 "수영장도 아닌데 파묻혀서 다닌다").
      // 소는 납작해서 put 이 낮은 쪽에 맞춰 깐다. 사람·차는 소에 못 들어가게 막는다.

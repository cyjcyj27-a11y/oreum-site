...
(function () {
  ...
  // 사장님 실주행으로 맞춘 값(2026-09-11): 비자림 2,066m 를 **100초**에 달렸다(제한 130초에 30초 남음).
  // 물리 모형의 최단이 82.9초였으니 사람의 실제 주행 = 모형 × 1.21. 그래서 1.2배 + 8초면 8초쯤 남는 빠듯함이다.
  const DEAL_MIN = 40, DEAL_MAX = 300, DEAL_SLACK = 1.2, DEAL_PARK = 8;

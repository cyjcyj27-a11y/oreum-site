...
(async function () {
  ...
  const turnArrow = (() => {
    ...
    const sp = new T.Sprite(new T.SpriteMaterial({ map: tex, alphaTest: 0.1, transparent: true, opacity: 0.3, toneMapped: false, fog: false, depthTest: false, depthWrite: false }));

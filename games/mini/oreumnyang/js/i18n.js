...
(function (global) {
  ...
  var EN = {
    ...
    'tip.progress': '{n} stages cleared · {s} stars',
    'credit':       'Sound · Kenney (kenney.nl) · Pixabay · OpenGameArt',

    'howto.title':  'How to play',
    'howto.1':      'Swap two neighbouring cats with your finger.',
    'howto.2':      'Line up <b>three or more</b> of the same cat, across or down, and they pop.',
    'howto.3':      'Four in a row makes a <b>Rocket cat</b> (clears a whole line). An L or T shape makes a <b>Bomb cat</b> (clears the 9 tiles around it). Five in a row makes a <b>Rainbow cat</b> (clears every cat of one colour).',
    'howto.4':      'Swap two special cats and the blast gets much bigger.',
    'howto.5':      'Clear the goals at the top <b>within the moves given</b> and the stage is done.',
    'howto.obs':    'What gets in your way',
    'howto.oreum':  '<b>Oreum</b> A layer under the cats — a Jeju volcanic hill. Pop cats on top of it and you climb one layer.',
    'howto.wall':   '<b>Stone wall</b> Jeju basalt. It will not move, but pops right beside it break it down.',
    'howto.carrot': '<b>Carrots</b> The cat is buried in a carrot patch and cannot move. Pop beside it to dig it out.',
    'howto.fruit':  '<b>Tangerine</b> Bring it down to the bottom row to harvest it. Clear the tiles below and it drops.',
